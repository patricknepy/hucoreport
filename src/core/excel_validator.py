                ...
                if match:
                    ...
                    if is_alternate:
                        ...
                        result['warnings'].append(
                            f"Col {col_letter}: Nom alternatif accepté '{cell_value}' (attendu '{expected_name}')"
                        )

                    result['columns_validated'][col_letter] = {
                        "status": "OK" if not is_alternate else "OK (nom alternatif)",
                        "found": cell_value,
                    ...
                    if is_ignored:
                        ...
                        result['warnings'].append(
                            f"Col {col_letter}: Attendu '{expected_name}', trouvé '{cell_value}' (colonne ignorée)"
                        )
                        result['columns_validated'][col_letter] = {
                            "status": "Ignoré",
                            "found": cell_value,
                        ...
                        result['warnings'].append(
                            f"Col {col_letter}: Attendu '{expected_name}', trouvé '{cell_value}'"
                        )
                        result['columns_validated'][col_letter] = {
                            "status": "Warning",
                            "found": cell_value,
